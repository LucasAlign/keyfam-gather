...
export function InvitationRegistrationForm({ token, invitation, fields }: { token: string; invitation: { firstName: string; lastName: string; email: string | null; phone: string | null }; fields: FieldDefinition[] }) {
