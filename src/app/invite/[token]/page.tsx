...
export default async function InvitationPage({ params }: { params: Promise<{ token: string }> }) {
  ...
  if (invitation.status === "SENT") await db.invitation.updateMany({ where: { id: invitation.id, status: "SENT" }, data: { status: openedStatus(invitation.status), openedAt: new Date() } });
