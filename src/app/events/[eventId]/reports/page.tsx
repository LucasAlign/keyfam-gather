...
export default async function ReportsPage({ params }: { params: Promise<{ eventId: string }> }) {
  ...
  return <>
    ...
    <div className="page-heading"><div><p className="eyebrow">Vertical 9 · Dashboard & reporting</p><h1>Reports & exports</h1><p>Monitor attendance, spot seating exceptions, and export canonical event data.</p><small className="live-note">Live report · refreshes every 5 seconds</small></div></div>
