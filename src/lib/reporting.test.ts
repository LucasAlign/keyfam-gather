...
const input: EventReportingInput = {
  registrations: [
    { id: "r1", firstName: "Ada", lastName: "Lovelace", email: "ada@example.test", phone: null, source: "INVITATION", registeredAt: new Date("2026-08-01T12:00:00Z"), group: "Analytical", table: "Table 1", party: null, checkedInAt: new Date("2026-08-13T18:00:00Z") },
    { id: "r2", firstName: "Grace", lastName: "Hopper, Jr.", email: null, phone: "555-0102", source: "WALK_IN", registeredAt: new Date("2026-08-13T18:05:00Z"), group: null, table: null, party: null, checkedInAt: null },
    { id: "r3", firstName: "Katherine", lastName: "Johnson", email: null, phone: null, source: "STAFF", registeredAt: new Date("2026-08-02T12:00:00Z"), group: "Analytical", table: "Table 1", party: null, checkedInAt: new Date("2026-08-13T18:10:00Z") },
  ],
  hosts: [{ firstName: "Alan", lastName: "Turing", email: null, phone: null, group: "Analytical" }],
  groups: [{ name: "Analytical", capacity: 2, registrationIds: ["r1", "r3"] }],
  tables: [{ name: "Table 1", capacity: 1, registrationIds: ["r1", "r3"] }],
